					 ...
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  ...
						  <input type="text" id="vendorDetailsVendorDistrict" name="vendorDetailsVendorDistrict" class="form-control">
						</div>
					  </div>					  
					 ...
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  ...
						  <input type="text" id="customerDetailsCustomerDistrict" name="customerDetailsCustomerDistrict" class="form-control">
						</div>
					  </div>					  
